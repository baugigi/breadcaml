...
--*)
(*++ *)
external mem_peek : int -> int -> int = "caml_nonstd_mem_peek"
let executable_name = ""
let os_type = match mem_peek 0x80 0xFF with
  | 0xAA -> "c64 kernal r1"
  | 0x00 -> "c64 kernal r2"
  | 0x03 -> "c64 kernal r3"
  | _ -> "unknown"
let backend_type = Other "BreadCaml"
