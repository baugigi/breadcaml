...
|=====
| *ITA* | *ENG*
| O64ml è un compilatore del linguaggio OCaml (https://ocaml.org) che produce
codice oggetto eseguibile sul Commodore 64 e suoi emulatori.
È stato ecc.ecc.
| O64ml is a compiler of the OCaml language (https://ocaml.org) which generates
object code targeted for the Commodore 64 and its emulators.
Blah blah...
|=====
